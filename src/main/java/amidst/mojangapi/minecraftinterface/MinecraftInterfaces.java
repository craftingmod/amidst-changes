...
import amidst.mojangapi.minecraftinterface.legacy._b1_7_3ClassTranslator;
import amidst.mojangapi.minecraftinterface.legacy._b1_7_3MinecraftInterface;
...
public enum MinecraftInterfaces {
    ...
    private static Factory fromVersion(RecognisedVersion version) {
    	if(RecognisedVersion.isOlderOrEqualTo(version, _b1_7_3MinecraftInterface.LAST_COMPATIBLE_VERSION)) {
            return new Factory(_b1_7_3ClassTranslator.get(), _b1_7_3MinecraftInterface::new);

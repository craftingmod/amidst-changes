        ...
        return ClassTranslator
            ...
            .next()
                ...
                .thenDeclareRequired(CLASS_WORLD_GEN_SETTINGS)
                	.requiredMethod(METHOD_WORLD_GEN_SETTINGS_CREATE, "method_28021").real("java.util.Properties").end()
                	.requiredMethod(METHOD_WORLD_GEN_SETTINGS_OVERWORLD, "method_28032").end()
                	.requiredMethod(METHOD_WORLD_GEN_SETTINGS_OVERWORLD2, "method_28032").end()
            .next()
